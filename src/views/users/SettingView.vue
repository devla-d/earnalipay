...
export default {
  ...
  mounted() {
    document.title = "Settings";
     initialize.setupajax(this.$store.state.token);
      window.$.get("https://earnalipay.com/settings/", (data) => {
  ...
  methods:{
    updateDetails(){
      ...
      window.$.post('https://earnalipay.com/settings/',{btc_id:this.btc_id,usdt_id:this.usdt_id,perfect_money_id:this.perfect_money_id},
      (data)=>{
