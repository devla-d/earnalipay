                        ...
                        <ul class="uk-list uk-list-divider uk-margin-small-top">
                                ...
                                <div class="uk-flex uk-flex-middle">
                                    ...
                                    <div>
                                        <h3 class="uk-margin-remove-bottom">
                                            <span class="count" data-counter-end="35817">3495</span>
                                        </h3>
                            ...
                            <li>
                                <div class="uk-flex uk-flex-middle">
                                    ...
                                    <div>
                                        <h3 class="uk-margin-remove-bottom">
                                            <span class="count" data-counter-end="4400">2M+</span>
                                        </h3>
        ...
        <div class="uk-grid-medium uk-child-width-1-2@m in-testimonial-8" data-uk-grid>
            <div>
                <div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                    <img class="uk-position-bottom-right" src="@/assets/images/in-testimoni-2.png" alt="client-testimoni" width="200">
                    ...
                    <div class="uk-card-footer">
                        <img src="@/assets/images/in-client-testi-1.svg" alt="client-logo" width="54">
                        <blockquote>
            ...
            <div>
                <div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                    <img class="uk-position-bottom-right" src="@/assets/images/in-testimoni-3.png" alt="client-testimoni" width="200">
                    <div class="uk-card-header">
                        <blockquote>
                    ...
                    <div class="uk-card-footer">
                        <img src="@/assets/images/in-client-testi-2.svg" alt="client-logo" width="54">
                        <blockquote>
    ...
    <div class="uk-container">
        <div class="uk-grid-medium uk-child-width-1-3@m in-testimonial-7" data-uk-grid>
            <div>
                <div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                    <div class="uk-card-header">
                        <img src="@/assets/images/in-client-testi-3.svg" alt="client-logo" width="60">
                    </div>
                    ...
                    <div class="uk-card-footer">
                        <blockquote>
                            <footer>Gabrielle Barger<br><cite>Help Desk at appium</cite></footer>
                        </blockquote>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                    <div class="uk-card-header">
                        <img src="@/assets/images/in-client-testi-4.svg" alt="client-logo" width="60">
                    </div>
                    <div class="uk-card-body">
                        <blockquote>
                    ...
                    <div class="uk-card-footer">
                        <blockquote>
                            <footer>Melvin Cortez<br><cite>Cloud Architect at blossom</cite></footer>
                        </blockquote>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
                    <div class="uk-card-header">
                        <img src="@/assets/images/in-client-testi-5.svg" alt="client-logo" width="60">
                    </div>
                    <div class="uk-card-body">
                        <blockquote>
                            <p>Has been a great tool for me on monthly updates & helps to communicate the issues with us.</p>
                        </blockquote>
                    </div>
                    <div class="uk-card-footer">
                        <blockquote>
                            <footer>Franklin Clark<br><cite>Sales Analyst at mailgun</cite></footer>
                        </blockquote>
                    </div>
                </div>
            </div>
