...
const routes = [{
...

    {
        ...
        name: 'dashboard',
        component: () =>
            import ('@/views/users/DashboardView.vue'),
        meta: {
            requiredAuth: true
        }
    },
    {
        ...
        name: 'withdrawal',
        component: () =>
            import ('@/views/users/WithdrawView.vue'),
        meta: {
            requiredAuth: true
        }
    },

    {
        ...
        name: 'transactions',
        component: () =>
            import ('@/views/users/TransactionView.vue'),
        meta: {
            requiredAuth: true
        }
    },
    {
        ...
        name: 'settings',
        component: () =>
            import ('@/views/users/SettingView.vue'),
        meta: {
            requiredAuth: true
        }
    },
    {
        ...
        name: 'createinvest',
        component: () =>
            import ('@/views/users/CreateInvest.vue'),
        meta: {
            requiredAuth: true
        }
    },
    ...
    //{ path: '*', redirect: '/404' },
    {
        ...
        name: 'adminlogin',
        component: () =>
            import ('@/views/auth/AdminLogin.vue'),
